...
public class NFCActivity extends AppCompatActivity {
    ...
    private void readFromIntent(Intent intent) {
        ...
        if (NfcAdapter.ACTION_TAG_DISCOVERED.equals(action)
            ...
            tvNFCContent.setText("NFC Content: " + s);
            ApiNFCModel apiNFCModel = new ApiNFCModel();
            apiNFCModel.setUid(s);
            syncData(apiNFCModel);
//            buildTagViews(msgs);
        }
    }
...
//        String tagId = new String(msgs[0].getRecords()[0].getType());
    ...
    private void syncData(ApiNFCModel apiNFCModel) {
...
//        AppLog.i("last location--from blu-"+location.getLatitude());
        ...
        String projectId = "eu-west-1_Win4w1vkr";//intent.getStringExtra(Key.IntentKey.PROJECT_ID);
        ...
        ArrayList<ApiSensorModel> nfcInfos = new ArrayList<>();
        nfcInfos.add(apiNFCModel);
        apiLocationModel.setsensors(nfcInfos);
        ...
        intent.putExtra("uid", apiNFCModel.getUid());
